class SystemsController < ApplicationController
  ...
  # GET /systems/new
  def new
    @system = System.new(subsector_id: params[:subsector_id], q: params[:q], r: params[:r])
  end
  ...
  def create
    ...
    if @system.save
      redirect_to new_world_path(system_id: @system.id), notice: 'System was successfully created.'
    else
      render :new
    end
  end
